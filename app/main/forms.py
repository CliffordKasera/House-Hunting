...
class ListingForm(FlaskForm):
    ...
    view-date = DateField('Date', validators=[Required])
    view-start-time = TimeField('From', min="9:00", max="18:00", validators=[Required])
    view-end-time = TimeField('To', validators=[Required])
